...
const MovieCard: React.FC<MovieCardProps> = ({ data }) => {
  ...
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      ...
      />
      <div className="opacity-0 absolute top-0 transition duration-3 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw] group-hover:opacity-100">
        <img
          src={data?.thumbnailUrl}
          alt="Thumbnai"
        ...
        <div className="z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full transition shadow-md rounded-b-md">
          <div className="flex flex-row items-center gap-3">
            ...
            >
              <ChevronDownIcon className="text-white group-hover/item:text-neutral-300 h-6 w-6" />
            </div>
          </div>
